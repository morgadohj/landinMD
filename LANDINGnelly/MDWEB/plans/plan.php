...
foreach ($plans as $p) {
    $request = [
        "reason" => $p['name'],
        // "back_url" => "http://localhost/landing/landinMD/LANDINGnelly/MDWEB/mercadoPagoEvents/success.php",
        // adaptare la url para desarrollo usando ngrok
        "back_url" => "https://8eb2c463aced.ngrok-free.app/landing/landinMD/LANDINGnelly/MDWEB/mercadoPagoEvents/success.php",
        "auto_recurring" => [
            "frequency" => $p['freq'],
