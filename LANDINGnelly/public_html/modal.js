...
function openRegistrationModal(package, period) {
    ...
    // ============================================================================
    // Asegurar que no se trate como compra
...
function generatePaymentPreference(companyId, packageType, planId) {
    ...
    console.log('Generando enlace de pago con:', { companyId, packageType, planId });
    ...
    .catch(error => {
        ...
        $(loadingModal).modal('hide');
        document.body.removeChild(loadingModal);
        alert('Error de conexión al generar el enlace de pago: ' + error.message);
    });
}
